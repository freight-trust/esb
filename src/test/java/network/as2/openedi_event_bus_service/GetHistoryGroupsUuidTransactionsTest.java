...
/**
 * getHistoryGroupsUuidTransactions Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryGroupsUuidTransactionsTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryGroupsUuidTransactions request
        uuid = null;
        apiClient.getHistoryGroupsUuidTransactions(uuid, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
