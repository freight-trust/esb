...
/**
 * controls.retrieve-group-control Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsRetrieveGroupControlTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsRetrieveGroupControl request
        id = null;
        apiClient.controlsRetrieveGroupControl(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
