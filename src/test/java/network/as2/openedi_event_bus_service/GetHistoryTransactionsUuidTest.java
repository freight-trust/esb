...
/**
 * getHistoryTransactionsUuid Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryTransactionsUuidTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryTransactionsUuid request
        uuid = null;
        apiClient.getHistoryTransactionsUuid(uuid, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
