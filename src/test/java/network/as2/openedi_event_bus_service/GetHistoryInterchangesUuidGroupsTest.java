...
/**
 * getHistoryInterchangesUuidGroups Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryInterchangesUuidGroupsTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryInterchangesUuidGroups request
        uuid = null;
        apiClient.getHistoryInterchangesUuidGroups(uuid, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
