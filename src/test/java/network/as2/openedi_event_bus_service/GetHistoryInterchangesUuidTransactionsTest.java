...
/**
 * getHistoryInterchangesUuidTransactions Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryInterchangesUuidTransactionsTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryInterchangesUuidTransactions request
        uuid = null;
        apiClient.getHistoryInterchangesUuidTransactions(uuid, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
