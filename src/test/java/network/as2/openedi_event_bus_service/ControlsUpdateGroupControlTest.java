...
/**
 * controls.update-group-control Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsUpdateGroupControlTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsUpdateGroupControlWithEmptyBody request
        id = null;
        apiClient.controlsUpdateGroupControlWithEmptyBody(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
        ...
        // TODO set parameters for controlsUpdateGroupControlWithJson request
        id = null;
        GroupControl body = null;
        apiClient.controlsUpdateGroupControlWithJson(id, body, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
                test.assertEquals(200, ar.result().statusCode());
                //TODO add your asserts
            } else {
