...
/**
 * controls.retrieve-interchange-controls Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsRetrieveInterchangeControlsTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsRetrieveInterchangeControls request
        id = null;
        apiClient.controlsRetrieveInterchangeControls(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
