...
/**
 * controls.retrieve-partners Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsRetrievePartnersTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsRetrievePartners request
        name = null;
        apiClient.controlsRetrievePartners(name, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
