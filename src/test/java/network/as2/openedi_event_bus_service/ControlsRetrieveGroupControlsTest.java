...
/**
 * controls.retrieve-group-controls Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsRetrieveGroupControlsTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsRetrieveGroupControls request
        id = null;
        apiClient.controlsRetrieveGroupControls(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
