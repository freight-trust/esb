...
/**
 * getHistoryInterchangesUuid Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryInterchangesUuidTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryInterchangesUuid request
        uuid = null;
        apiClient.getHistoryInterchangesUuid(uuid, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
