...
/**
 * controls.retrieve-partner Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsRetrievePartnerTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsRetrievePartner request
        id = null;
        apiClient.controlsRetrievePartner(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
