...
/**
 * getHistoryGroupsUuid Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryGroupsUuidTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryGroupsUuid request
        uuid = null;
        apiClient.getHistoryGroupsUuid(uuid, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
