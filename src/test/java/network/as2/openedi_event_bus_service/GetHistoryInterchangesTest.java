...
/**
 * getHistoryInterchanges Test
 */
@RunWith(VertxUnitRunner.class)
public class GetHistoryInterchangesTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for getHistoryInterchanges request
        page = null;
        apiClient.getHistoryInterchanges(page, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
