...
/**
 * deleteSchemasStandardTypeVersionFile Test
 */
@RunWith(VertxUnitRunner.class)
public class DeleteSchemasStandardTypeVersionFileTest extends BaseTest {
    ...
    public void testDefault(TestContext test) {
        ...
        // TODO set parameters for deleteSchemasStandardTypeVersionFile request
        file = null;
        standard = null;
        type = null;
        version = null;
        apiClient.deleteSchemasStandardTypeVersionFile(file, standard, type, version, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
