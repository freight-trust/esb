...
/**
 * controls.retrieve-interchange-control Test
 */
@RunWith(VertxUnitRunner.class)
public class ControlsRetrieveInterchangeControlTest extends BaseTest {
    ...
    public void test200(TestContext test) {
        ...
        // TODO set parameters for controlsRetrieveInterchangeControl request
        id = null;
        apiClient.controlsRetrieveInterchangeControl(id, (AsyncResult<HttpResponse> ar) -> {
            if (ar.succeeded()) {
